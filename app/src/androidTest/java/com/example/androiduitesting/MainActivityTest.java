...
public class MainActivityTest {
    ...
    // The following tests are from High-Flyer, Deepseek, "Android UI Testing Help", 2026-02-26
    @Test
    public void testActivitySwitch() {
        ...
        // Verify that ShowActivity is displayed by checking its TextView
    ...
    public void testCityNameConsistency() {
        ...
        // Check that the city name in ShowActivity is "Edmonton"
    ...
    public void testBackButton() {
        ...
        // Verify we are back in MainActivity (the Add button should be visible)
